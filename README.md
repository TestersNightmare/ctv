...
[![Version: 1.0](https://img.shields.io/badge/Version-1.0-blue.svg)](https://github.com/TestersNightmare/ctv/releases)
...
2，新增默认桌面设置，可以开机直接进入播放，完美恢复老一代电视机播放体验。

3，新增图片轮播屏保。轮播图片需要放置进本机存储里的图片文件夹，或者SD卡USB设备上默认的安卓图片路径。

## 安装指南

1. **下载 APK**：从 [Releases 页面](https://github.com/TestersNightmare/ctv/releases) 获取最新版本。
